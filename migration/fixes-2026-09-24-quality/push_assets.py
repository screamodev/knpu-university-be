#!/usr/bin/env python3
"""
Залити файли правок 23.09, п. 2 (Центр забезпечення якості освіти): описи п'яти дисциплін
вільного вибору магістрів, 2025/2026 навчальний рік, цикл професійної підготовки —
«Адміністративний менеджмент», «Актуальні проблеми психологічної науки і практики»,
«Прикладні аспекти психології», «Психологічний супровід процесу реабілітації»,
«Управлінські технології в освіті».

PDF надіслав клієнт, лежать у `files/`.
