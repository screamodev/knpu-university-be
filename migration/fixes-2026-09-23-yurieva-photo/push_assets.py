#!/usr/bin/env python3
"""
Залити файл правок 22.09 (кафедра образотворчого мистецтва): портрет Юр'євої Катерини
Анатоліївни для сітки співробітників на Головній — раніше сьогодні її додали без фото, бо
докс його не містив, клієнт прислав знімок окремо.

Фото прийшло на пошту, байти лежать у `files/` в git (854×1280 — вже в межах 1600 px, не
стискалось).
