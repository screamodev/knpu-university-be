#!/usr/bin/env python3
"""
Залити файли правок 14.09: результати трьох анкет 2026 року за ОП «Тифлопедагогіка. Сурдопедагогіка»
(ННІ спеціальної освіти та інклюзії) для вкладки «Якість освіти».

Файли надіслав Центр якості освіти, тож їхні байти лежать у `files/` в git —
качати під час деплою немає звідки. uuid кожного файла детермінований (uuid5 від імені у
просторі `https://hnpu.edu.ua/migration/fixes-2026-09-14`), тож `/assets/<uuid>` у текстах
