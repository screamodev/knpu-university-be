#!/usr/bin/env python3
"""
Залити файли правок 19.09: фото деканату ННІ спеціальної освіти, портрети деканів фізмату,
фото виховної роботи факультету історії і права.

Усі файли прийшли поштою; фото вже зменшені до вебформату (довша сторона 1600 px, JPEG), байти
лежать у `files/` в git.
