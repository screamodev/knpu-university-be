#!/usr/bin/env python3
"""
Залити файли правок 11.09: контингент здобувачів на 01.09.2026, фото О. С. Казачінер для Центру
інклюзивної освіти та документи Центру карʼєрного зростання про одноразову допомогу випускникам.

Файли прийшли поштою або вийняті з PDF правок, тож їхні байти лежать у `files/` в git —
качати під час деплою немає звідки. uuid кожного файла детермінований (uuid5 від імені у
просторі `https://hnpu.edu.ua/migration/fixes-2026-09-11`), тож `/assets/<uuid>` у текстах
