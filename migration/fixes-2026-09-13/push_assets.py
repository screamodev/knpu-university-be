#!/usr/bin/env python3
"""
Залити файли правок 13.09: емблему й загальне фото Студентського Парламенту та шість фото
з квартирника «Коли серце говорить вголос» для сторінки студентського самоврядування.

Усі файли вийняті з PDF правок клієнта, тож їхні байти лежать у `files/` в git —
качати під час деплою немає звідки. uuid кожного файла детермінований (uuid5 від імені у
просторі `https://hnpu.edu.ua/migration/fixes-2026-09-13`), тож `/assets/<uuid>` у текстах
