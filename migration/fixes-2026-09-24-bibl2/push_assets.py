#!/usr/bin/env python3
"""
Залити файли правок 23.09, п. 8 (Наукова бібліотека): тексти п'яти біобібліографічних
покажчиків 2026 року — Калашник М. П., Маленко О. О., Троцко А. В., Хомуленко Т. Б.,
Штефан Л. А. Посилання на них стоять на сторінках «Бібліографічні покажчики» і «Видатні вчені
