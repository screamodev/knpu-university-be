#!/usr/bin/env python3
"""
Залити файли правок 08.09: угоди й договори кафедри спеціальної педагогіки, звіти
Студентського Парламенту, плани заходів Центру інклюзивної освіти.

Дві категорії файлів:

* публічні теки на Google Drive (угоди, договори, звіти) — у карті стоїть `drive_id`,
  скрипт качає їх сам і кладе поруч у `files/` (тека в .gitignore);
* файли з приватної теки університету (плани Центру інклюзивної освіти) — `drive_id: null`,
  байти лежать у `files/` в git, бо взяти їх під час деплою нема звідки.
