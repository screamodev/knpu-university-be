#!/usr/bin/env python3
"""
Залити файли правок 23.09, п. 6 (Наукова бібліотека): тексти чотирьох біобібліографічних
покажчиків 2025 року — Гавриш І. В., Зеленська Л. Д., Козіна Ж. Л., Попова О. В. Посилання на
них стоять на сторінках «Бібліографічні покажчики» і «Видатні вчені ХНПУ імені Г. С. Сковороди».
