#!/usr/bin/env python3
"""
Залити файл правок 22.09 (ННІ української філології): фото нового члена керівництва
інституту — Юр'єва Жаннетта Альбертівна, координатор з виховної роботи.

Фото прийшло на пошту, байти лежать у `files/` в git (764×1111, вже в межах 1600 px — не
стискалось).
