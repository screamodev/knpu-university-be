#!/usr/bin/env python3
"""
Залити файли правок 22.09 (кафедра образотворчого мистецтва): описи двох освітніх програм
2026 року — «А4.12 Середня освіта (Мистецтво. Образотворче мистецтво)» бакалаврат і
«В4 Образотворче мистецтво та реставрація» (прикладна графіка).

Обидва PDF — публічні файли з Google Drive кафедри, `drive_id` у карті; скрипт качає їх сам,
у git не лежать.
