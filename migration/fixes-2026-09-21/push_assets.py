#!/usr/bin/env python3
"""
Залити файли правок 21.09: результати анкетування 2026 (Центр забезпечення якості освіти) —
ОП «Образотворче мистецтво в закладах освіти» і «Китайська мова і література».

PDF прийшли від центру, байти лежать у `files/` в git.
